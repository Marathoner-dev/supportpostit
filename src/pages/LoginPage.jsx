...
const LoginPage = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // 로그인 성공 시 홈으로 리다이렉트 (useEffect에서 처리됨)
      navigate("/");
    } catch (error) {
        ...
        >
          ...
          {error && (
            <motion.div
              ...
              style={{ backgroundColor: '#FFF4F4', border: '1px solid #FFE5E5', color: '#F04452' }}
            >
              {error}
            </motion.div>
          )}
          ...
          <div className="space-y-6">
            ...
            <motion.button
              ...
              disabled={isLoading}
              className="w-full py-4 px-6 bg-white rounded-2xl font-semibold transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
              style={{ 
